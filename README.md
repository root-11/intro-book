...
[§42 - You can only fix what you wrote](#42---you-can-only-fix-what-you-wrote) extends compression-oriented programming to dependencies: every crate is somebody else's abstraction; adopting it is a bet that their compression matches yours.
