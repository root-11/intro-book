...
[§42 - You can only fix what you wrote](42_you_can_only_fix_what_you_wrote.md) extends compression-oriented programming to dependencies: every crate is somebody else's abstraction; adopting it is a bet that their compression matches yours.
